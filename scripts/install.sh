...
# apache2
sed -i 's/CustomLog .* combined/CustomLog \$\{APACHE_LOG_DIR\}\/access.log combined/' /var/www/adct/etc/adct*.conf
sed -i 's/ErrorLog .*/ErrorLog \$\{APACHE_LOG_DIR\}\/error.log/' /var/www/adct/etc/adct*.conf
